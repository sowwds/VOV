<template>
      ...
      >
        <div>
          ...
          <div v-show="isExpanded" class="p-4 space-y-3">
            ...
            <!-- Включение/выключение анимации визуализатора -->
            <div class="flex items-center justify-between px-3 py-2">
              <span class="text-gray-700 dark:text-gray-300">Анимация визуализатора</span>
              <AnimationToggle size="w-17 h-6" />
            </div>
            <!-- Разделитель -->
  ...
  import AnimationToggle from '@/components/Header/AnimationToggle.vue'; // Import the new toggle component
